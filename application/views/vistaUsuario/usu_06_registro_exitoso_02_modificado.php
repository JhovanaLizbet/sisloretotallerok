        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3>Los datos del usuario fueron modificados correctamente.</h3>
                </div>
                <div class="modal-footer">
                    <a href="<?php echo base_url(); ?>index.php/administrador/listaUsuarios">
    ...
    <script>
        $(document).ready(function() {
            ...
            setTimeout(function() {
                ...
                setTimeout(function() {
                    window.location.href = "<?php echo base_url(); ?>index.php/administrador/listaUsuarios";
