...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
 ...
 -->
  ...
  <br>
  <!-- 
  <a href="<?php echo base_url(); ?>index.php/usuarios/agregarUsuario">
  ...
  <a href="<?php echo base_url(); ?>index.php/usuarios/listaUsuariosDeshabilitados">
    <button type="button" class="btn btn-warning">Lista Deshabilitadoss <i class="bi bi-person-x-fill"></i></button>
  </a>
