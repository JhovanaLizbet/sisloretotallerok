		...
		<nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
			<div class="position-sticky">
				...
				<ul class="nav flex-column">
					...
					<li class="nav-item">
						<a class="nav-link" href="<?php echo base_url(); ?>index.php/recibo/generarReciboPDF3">
							<i class="fas fa-swimmer"></i> Reporte Inscripcion
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="<?php echo base_url(); ?>index.php/inscripcion/verRangosEntreFechas">
							<i class="fas fa-swimmer"></i> Reportes rangos
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="<?php echo base_url(); ?>index.php/inscripcion/verCantidadCursos">
							<i class="fas fa-swimmer"></i> Reportes cantidad
						</a>
					</li>
