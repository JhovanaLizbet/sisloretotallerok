...
/*////////////////////////*/
        /* FIN  Estilos para el botón de perfil */
...
*/
        /* Estilos CSS personalizados para los submenús */
        .submenu {
            background-image: none;
            /* Elimina el aspecto rayado del fondo */
            box-shadow: none;
        ...
        .submenu:active {
            ...
            /* Color de fondo cuando el submenú está activo */
        }

        /* Estilos para el submenú cuando el mouse está sobre él */
        .submenu:hover {
            background-color: white;
            /* Color de fondo cuando el mouse está sobre el submenú */
        }

        .submenu li a {
            color: blue;
            /* Cambia el color del texto a azul o el color que prefieras */
        }
