        ...
        <footer>
            <section>
                ...
                <div class="container-fluid p-0 mb-5">
                    ...
                    <center>
                        <h6 class="text-blue mb-3">Copyright &copy; 2023. Todos los derechos reservados</h6>
                    </center>
                    <center>
                        <h6 class="text-blue mb-3">Diseñado por: Jhovana Flores</h6>
                    </center>
                </div>
                <!-- Carousel End -->
            </section>
        ...
        <script>
            $(document).ready(function() {
                // Agrega un controlador de clic a los elementos de menú con submenús
                $('.nav-link').click(function() {
                    // Encuentra el submenú dentro del elemento de menú actual
                    var submenu = $(this).next('.submenu');

                    // Alternar la visibilidad del submenú al hacer clic en el elemento de menú
                    submenu.slideToggle();
                });
            });
        </script>
