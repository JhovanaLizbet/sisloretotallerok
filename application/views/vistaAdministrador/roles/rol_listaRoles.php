...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
 ...
 -->
    ...
    <div class="container mt-4">
        <h2 align="center"><u>Lista de Roles</u></h2>
        <!-- Agrega el contenido de tu página aquí -->
    </div>
    <br>
    <a href="<?php echo base_url(); ?>index.php/administrador/agregarRol">
        <button type="button" class="btn btn-primary">Crear Rol <i class="fa fa-user-plus"></i></button>
    </a>

    <a href="<?php echo base_url(); ?>index.php/administrador/listaRolesDeshabilitados">
        <button type="button" class="btn btn-warning">Roles Deshabilitados <i class="bi bi-person-x-fill"></i></button>
    </a>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php
                            echo form_open_multipart('administrador/modificarRol');
                            ?>
                            <input type="hidden" name="idRol" id="idrol" value="<?php echo $row->id; ?>">
                        ...
                        <td>
                            <?php
                            echo form_open_multipart('administrador/deshabilitarRol');
                            ?>
