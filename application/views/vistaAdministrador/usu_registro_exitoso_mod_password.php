...
<body>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3>La contraseña fue modificada correctamente.</h3>
                    <h5>Se cerrará sesion para ingresar nuevamente con los datos modificados.</h5>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var tiempoEspera = 2500; // 4 segundos en milisegundos
            setTimeout(function() {
