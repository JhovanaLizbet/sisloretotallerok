    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div>
                ...
                <h3 class="text-primary posicion"><b style="color: white;">.......</b>Crear Nuevo Instructor</h3>
                    ...
                    <div class="col-5">
                        <div class="card">
                            <div class="card-header">
                                <center>
                                    <h4 class="card-title">Rellene el formulario para crear un nuevo Instructor</h4>
                                </center>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <?php
                                echo form_open_multipart('administrador/agregarInstructorBDD');
                                ?>
