...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="container mt-4">
        <h2 align="center"><u>Lista de Instructores Deshabilitados</u></h2>
        <!-- Agrega el contenido de tu página aquí -->
    </div>
    <br>

    <a href="<?php echo base_url(); ?>index.php/administrador/indexInstructores">
        <button type="button" class="btn btn-warning">Instructores Habilitados  <i class="bi bi-person-check-fill"></i></button>
    </a>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <?php
                            echo form_open_multipart('administrador/habilitarInstructor');
                            ?>
