            ...
            <div class="container-fluid">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        ...
                        <center>
                            <h3 class="text-primary">Modificar datos del Instructor</h3>
                        </center>
                    </div>
                    <div class="col-sm-4">
                        <h1></h1>
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php
                                foreach ($datosDelInstructor->result() as $row) {
                                    echo form_open_multipart('administrador/modificarInstructorBDD');
                                ?>

                                    <input type="texto" id="idInstructor" name="idInstructor" value="<?php echo $row->id ?>" class="form-control">
                            ...
                            <a href="<?php echo base_url(); ?>index.php/administrador/indexInstructores">
