    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div>
                ...
                <center><h3 class="text-primary">Bienvenido a la Escuela de Natacion</h3></center>
                <center><h3 class="text-primary">Centro Acuatico Loreto</h3></center>

                <h3 class="text-primary posicion"><b style="color: white;">...........</b> pagina para el clientes</h3>
                    ...
                    <div class="col-5">
                        <div class="card">
                            <div class="card-header">
                                <center>
                                    <h5 class="card-title">Por favor, llenar los siguientes campos para poder afiliarse.</h5>
                                </center>
                            </div>
                            <!-- /.card-header 
                            <div class="card-body">
                                <?php
                                echo form_open_multipart('usuarios/registrarCliBDD');
                                ?>
                                ...
                                <b>Razon Social:</b>
                                <input type="text" name="razonSocial" placeholder="Razon Social / NIT" class="form-control input-md" required aria-invalid="true">
                                <?php echo form_error('razonSocial'); ?>

                                <b>Direccion:</b>
                                <input type="text" name="direccion" placeholder="Direccion" class="form-control input-md" required aria-invalid="true">
                                ...
                                <b>Celular:</b><img src="<?php echo base_url();?>adminlte/dist/img/wat2.png">
                                <input type="text" id="telefono" name="telefono" placeholder="Numero de celular con Whatsapp" class="form-control input-md" required aria-invalid="true" pattern="[0-9]+">
                            ...
                            <a href="<?php echo base_url(); ?>index.php/administrador/indexClientes">
