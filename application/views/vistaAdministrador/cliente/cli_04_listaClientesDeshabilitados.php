...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="container mt-4">
        <h2 align="center"><u>Lista de Clientes Deshabilitados</u></h2>
        <!-- Agrega el contenido de tu página aquí -->
    </div>
    <br>

    <a href="<?php echo base_url(); ?>index.php/administrador/listaClientesHab">
        <button type="button" class="btn btn-warning">Clientes Habilitados  <i class="bi bi-person-check-fill"></i></button>
    </a>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <?php
                            echo form_open_multipart('administrador/habilitarCliente');
                            ?>
