...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <section>
        <div class="menu">
            <div class="profile-button derecho">
                ...
                <h1>ESTAS EN LA PAGINA DEL CLIENTE.............</h1>
 ...
 -->
    ...
    <br>
    <a href="<?php echo base_url(); ?>index.php/administrador/agregarCliente">
        <button type="button" class="btn btn-primary">Crear Cliente <i class="fa fa-user-plus"></i></button>
    </a>

    <a href="<?php echo base_url(); ?>index.php/administrador/listaClientesDeshabilitados">
        <button type="button" class="btn btn-warning">Clientes Deshabilitados <i class="bi bi-person-x-fill"></i></button>
    </a>
    ...
    <div id="content" class="tabla-contenedor">
        ...
        <table id="example" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                foreach ($listaClientes->result() as $row) // de la base de datos
                {
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php
                            echo form_open_multipart('administrador/modificarCliente');
                            ?>
                            <input type="hidden" name="idCliente" id="idcliente" value="<?php echo $row->id; ?>">
                        ...
                        <td>
                            <?php
                            echo form_open_multipart('administrador/deshabilitarCliente');
                            ?>
                            <input type="hidden" name="idCliente" value="<?php echo $row->id; ?>">
